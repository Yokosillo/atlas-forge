...
from atlas_forge.architect.propose_user_stories import ProposedUserStories
...
def write_approved_stories(
    ...
    # T-AF036-US03-03 (validación del flujo completo): se crea el
    # directorio de salida si no existe — en un proyecto recién sembrado
    # (o aislado de test) `02-backlog/user-stories/` puede no existir
    # todavía, y la escritura fallaba con FileNotFoundError (500) pese a
    # que el pipeline ya había aprobado las historias.
