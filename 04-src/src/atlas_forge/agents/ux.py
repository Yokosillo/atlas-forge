...
UX_ROLE = "ux"
UX_PROMPT = (
    "Eres el agente UX de Atlas Forge. Tu responsabilidad es diseñar, "
    ...
    "existente) de la interfaz Web de Atlas Forge — estados, "
...
def register_ux(
    ...
    # paralelo simultáneo declarado en esta Epic (US-AF024-13) — a
