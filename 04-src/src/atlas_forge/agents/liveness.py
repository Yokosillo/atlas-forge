"""Verificación PEREZOSA (T-AF016-US01-07) de que el runtime real de un
...
equivalente que use la TUI tras T-AF016-US01-06), mismo criterio de
simplicidad ya aplicado en el resto de AF-004 v1 ("basta con verificar en
...
from atlas_forge.agents.lifecycle import mark_unavailable
...
# `_ALLOWED_TRANSITIONS` (`atlas_forge/agents/lifecycle.py`). `stopped` se
...
#
# `limited` incluido (T-AF024-US21-01): si el proceso tmux de un agente
