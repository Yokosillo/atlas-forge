...
from atlas_forge.agent_model import _CATALOG_RUNTIME_TO_REAL_TYPE, get_available_model_entries
from atlas_forge.agents.roles import list_roles
from atlas_forge.model_preferences import load_model_preferences


@dataclass(frozen=True)
class AgentLaunchOption:
    """Una combinacion disponible de rol + modelo para elegir antes de
    lanzar (T-AF022-US11-01). No incluye logica de lanzamiento — solo
