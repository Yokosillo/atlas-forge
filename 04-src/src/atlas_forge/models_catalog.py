"""Catalogo de modelos disponibles (T-AF022-US09-01): fichero de configuracion
...
## Formato del manifiesto: `.atlas-forge/models.yml`, YAML

Mismo patron que `project_scripts.py` (`.atlas-forge/scripts.yml`):
...
CATALOG_RELATIVE_PATH = Path(".atlas-forge") / "models.yml"
...
class ModelEntry:
    ...
    (T-AF008-US12-01: mapeo dificultad↔modelo).
...
def load_model_catalog(
    ...
    `.atlas-forge/models.yml` en la raiz del repo de Atlas Forge) y
