...
class ScriptEntry:
    ...
    manifiesto (T-AF001-US03-01) — `id` es el identificador estable por el
    que `run_project_script` (T-AF001-US03-02) lo localizará para
    ...
    en `Runtime.command`/`run_command`, `atlas_forge.tmux.manager`)."""
