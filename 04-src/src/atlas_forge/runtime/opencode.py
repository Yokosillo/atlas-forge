...
# Configuración por defecto de OpenCode como Runtime (T-AF004-US02-01).
...
# Code en T-AF004-US01-02).
DEFAULT_OPENCODE_COMMAND = "opencode"

# Flag de máxima autonomía/mínima fricción (T-AF002-US01-01), equivalente
