...
# Configuración por defecto de Claude Code como Runtime (T-AF004-US01-02).
...
# Flag de máxima autonomía/mínima fricción (T-AF002-US01-01): evita que el
# agente quede bloqueado pidiendo confirmación de cada acción. Mismo
# criterio ya en uso en la sesión tmux real `claude-atlas-forge` de este
...
def register_claude_code_runtime(
    ...
    Corrección T-AF024-US11-13 (2026-08-17): la premisa original ("Claude
