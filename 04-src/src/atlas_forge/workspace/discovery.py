...
# Caché TTL (T-AF001-US01-06): `discover_projects` recorre el filesystem
...
def discover_projects(
    ...
    *,
    ...
    Workspace al que pertenecen (T-AF001-US02-02).
    ...
    registrado para `root` si existe (CRUD de T-AF001-US02-01), o un id
    ...
    # p. ej. al registrar vía el CRUD (T-AF001-US02-01) un Workspace para una
...
def _discover_projects_walk(root: Path, workspace_id: str) -> list[Project]:
    ...
    for current_dir, subdir_names, _file_names in os.walk(root):
        ...
        # interna (p. ej. `.atlas_forge`, `.venv`, `.git`) que puede contener su
    ...
    # pantalla Workspace presente los proyectos siempre igual (T-AF001-US01-05).
