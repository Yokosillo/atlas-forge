...
# Mecanismo de persistencia (T-AF001-US02-01):
#
# Decision explícita, siguiendo el criterio ya que aplicamos en
# T-AF001-US01-01 (ficha simple JSON en lugar de SQLite):
#
# docs/concepts.md sitúa `Workspace` por encima de `Project`
# y `Development Session`, pero en este Task (T-AF001-US02-01) el Workspace
...
# concreto es trabajo de la siguiente Task (T-AF001-US02-02), momento en que
...
# T-AF001-US02-02, o el índice de AF-007 Knowledge Engine), no para este caso.
...
def derive_workspace_id(path: Path) -> str:
    ...
    no registrado todavía (T-AF001-US02-02): derivado del path absoluto.
    ...
    con ese path vía el CRUD (T-AF001-US02-01), `resolve_workspace_id` pasa a
...
def delete_workspace(
    ...
    *,
    ...
    Tasks posteriores (T-AF001-US02-02).
    """
