...
from atlas_forge.models import Job, JobPlan

# Mismo problema y misma solución que `job_cancellation_registry.py` para
# `Job` (T-AF008-US05-01): `dispatch_plan` corre bloqueante dentro del hilo
...
# `POST /plans/{id}/cancel`, T-AF016-US01-17) sin coordinarse por fuera de
...
# (`atlas_forge/api/plan_registry.py`, ver su docstring: "un concepto de
...
# (criterio de aceptación de T-AF008-US08-01, reutilizando
# `T-AF008-US05-01`) — pero el `Job` de un paso "agent" es una variable
