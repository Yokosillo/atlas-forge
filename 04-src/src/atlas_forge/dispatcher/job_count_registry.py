"""Historial mínimo de Jobs despachados por agente/sesión (T-AF008-US03-02,
...
- Extender `DevelopmentSession` con un contador por agente. Se descarta:
  ...
  (US-AF002-02/03/04) — añadir un campo que solo el Dispatcher necesita
...
- Un registro nuevo, específico del Dispatcher, en memoria de proceso.
  ...
  `_SessionRegistry` (`atlas_forge/core/session_registry.py`) — un contador
