"""Detección de si una User Story "toca `10-web/`" (T-AF022-US15-04,
US-AF022-15).

## Mecanismo elegido: heurística sobre los informes de cierre ya
## existentes, no un campo nuevo de frontmatter

La Task propone tres opciones (ver `T-AF022-US15-04-disparo-automatico-tester-al-cerrar-us.md`,
...
- **Campo nuevo en frontmatter (`touches_web`)**: descartada para esta
  ...
  (`atlas_forge.backlog.parser`), el validador (`validate_backlog_content_v2`)
...
- **Heurística sobre el informe de cierre** (elegida): cada informe de
  ...
  p. ej. `07-informes/US-AF036-01/US-AF036-01.md`). Es información que
