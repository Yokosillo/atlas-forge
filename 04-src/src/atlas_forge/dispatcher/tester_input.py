...
Tester (T-AF022-US12-01, T-AF022-US12-02).
...
def build_tester_input_package(
    ...
    estructurado (T-AF022-US12-01): código tocado, criterios de aceptación
...
def build_tester_job_description(
    ...
    """Construye la descripción completa del Job del Tester (T-AF022-US12-01
    + T-AF022-US12-02): empaqueta la entrada Y la instrucción de análisis
    ...
    return (
        f"Eres el Tester del pipeline de Atlas Forge. Tu responsabilidad "
