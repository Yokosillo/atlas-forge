...
operación (T-AF016-US01-04): hasta ahora, `create_job` (AF-008 v1) y
`record_job` (`job_history_registry`, T-AF002-US03-03) eran dos llamadas
...
`list_jobs_for_session`/`record_job` ya viven en `atlas_forge.dispatcher` desde
T-AF002-US03-03 — es cerrar el hueco de que crear un Job y registrarlo
