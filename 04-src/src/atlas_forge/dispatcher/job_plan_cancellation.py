"""Cancelar un `JobPlan` en curso (T-AF008-US08-01, US-AF008-08): mecanismo
de dominio que un futuro endpoint HTTP (`POST /plans/{id}/cancel`,
T-AF016-US01-17, fuera del alcance de esta Task) invocará desde OTRA
...
T-AF008-US05-01 (`job_cancellation.request_cancellation`) para el paso
...
def request_cancellation(plan: JobPlan) -> None:
    ...
    T-AF008-US05-01) — el agente involucrado queda `idle`, no se mata su
