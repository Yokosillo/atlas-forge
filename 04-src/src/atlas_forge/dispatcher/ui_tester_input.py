...
(T-AF022-US15-04, US-AF022-15) — amplía el contrato de entrada del
Tester de `tester_input.py` (US-AF022-12) con la instrucción de navegar
...
def build_ui_tester_job_description(
    ...
    return (
        f"Eres el Tester de UI de Atlas Forge. La User Story "
