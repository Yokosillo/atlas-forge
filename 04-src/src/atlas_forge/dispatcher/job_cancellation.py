"""Cancelar un Job en curso (T-AF008-US05-01, US-AF008-05): mecanismo de
dominio que un futuro endpoint HTTP (`POST /jobs/{id}/cancel`,
T-AF016-US01-15, fuera del alcance de esta Task) invocará desde OTRA
...
from atlas_forge.dispatcher.job_cancellation_registry import request_job_cancellation
