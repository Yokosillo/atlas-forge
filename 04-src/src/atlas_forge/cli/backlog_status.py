"""Comando `atlas_forge backlog-status <backlog_path>` (T-AF018-US02-02,
...
`classify_todo_items`/`find_max_leverage_chain` de T-AF018-US02-01) y
...
from atlas_forge.backlog import build_backlog_report, format_human_report, render_json_report
...
def run_backlog_status(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(
        prog="atlas_forge backlog-status",
