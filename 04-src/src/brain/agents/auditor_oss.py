...
AUDITOR_OSS_PROMPT = (
    "Eres el agente Auditor-OSS de Factory Brain. Tu responsabilidad es "
    "evaluar Factory Brain como lo haría un maintainer senior de "
...
def register_auditor_oss(
    ...
    # Instancia única reutilizada, mismo criterio que UX (T-FB024-US13-01)
