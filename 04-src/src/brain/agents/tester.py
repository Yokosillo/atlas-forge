"""Registro del rol Tester en el backend (T-FB022-US15-01).
...
TESTER_ROLE = "tester"
TESTER_PROMPT = (
    "Eres el agente Tester de Factory Brain. Tu responsabilidad exclusiva "
...
def register_tester(
    ...
    """Registra el agente Tester con reuso (T-FB022-US15-01): igual que
