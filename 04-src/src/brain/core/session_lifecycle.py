...
# (ver 02-backlog/epics/FB-003-development-session.md, "Alcance v1").
# `paused` pertenece al ciclo de vida completo (v2, US-FB003-03) y no es
...
def assign_agent(session: DevelopmentSession, agent: Any) -> None:
    ...
    `Agent` pertenece a FB-005, Epic posterior a esta Task).
    """
