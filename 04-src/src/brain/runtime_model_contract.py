...
(T-FB005-US07-01): define qué operaciones de modelo cada runtime soporta.
...
Definidas por la Task `US-FB005-07` como requerimiento de dominio.
"""
...
_RUNTIME_CAPABILITIES: dict[RuntimeType, RuntimeModelCapabilities] = {
    RuntimeType.OPENCODE: RuntimeModelCapabilities(
        ...
        can_change_model_idle_only=True,  # T-FB024-US11-11: riesgo, solo en idle
