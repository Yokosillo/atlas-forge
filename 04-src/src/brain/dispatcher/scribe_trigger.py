"""Mecanismo de disparo automático de Scribe (T-FB008-US03-01, FB-008
Dispatcher v2): decide CUÁNDO invocar a Scribe (FB-014) antes de
...
conexión es T-FB008-US03-02 (ver también las notas de diseño de esa Task
...
FB-007), no para este mecanismo de disparo del Dispatcher.
"""
...
def should_invoke_scribe_by_job_count(
    ...
    una decisión explícitamente diferida a T-FB008-US03-02 ("confirmar
...
def compose_job_instruction_with_scribe_context(
    ...
    encadenar el resultado de un Job anterior (T-FB008-US02-01), con un
