"""Test de integración para la detección de instancias de brain-api
(T-FB037-US01-01, criterio 3): lanzar dos instancias en puertos
...
def test_detect_running_instance_integration(tmp_path, caplog):
    """T-FB037-US01-01, criterio 3: arrancar brain-api en dos puertos
    ...
    # 1. Arrancar brain-api en puerto 8000
    # 2. Esperar a que responda GET /projects
    # 3. Arrancar brain-api en puerto 8001
    ...
    pytest.skip(
        ...
        "1. brain-api --port 8000 (en tmux pane 1) "
        "2. brain-api --port 8001 (en tmux pane 2, mismo socket)"
